...
app.on('ready', () => {
  ...
  // Clear out the main window when the src is closed
  ...
  let appTitle: string = `Hotel Management System`;
  ...
  let helpMenu: any = {
    ...
    submenu: [{
      label: 'Learn More',
      click:() => {
        shell.openExternal('https://github.com/pavan-08/ddb-miniproject');
      }
    }, {
        label: 'Issues',
        click:() => {
          shell.openExternal('https://github.com/pavan-08/ddb-miniproject/issues');
        }
      }, {
